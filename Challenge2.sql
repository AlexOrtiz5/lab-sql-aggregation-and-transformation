-- 1. Next, you need to analyze the films in the collection to gain some 
-- more insights. Using the film table, determine:
...
-- understand the popularity of different film ratings and adjust 
...
-- two decimal places. This will help identify popular movie lengths for 
-- each category.
SELECT 
    rating, 
